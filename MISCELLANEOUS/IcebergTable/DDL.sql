...
create or replace external volume iceberg_int
  ...
  (
    ...
    storage_base_url = 's3://icebergabhi/'

    storage_aws_role_arn = 'arn:aws:iam::886371026150:role/iceberg_role'
   ...
   "STORAGE_ALLOWED_LOCATIONS":["s3://icebergabhi/*"],

   "STORAGE_AWS_ROLE_ARN":"arn:aws:iam::886371026150:role/iceberg_role"

   ,"STORAGE_AWS_IAM_USER_ARN":"arn:aws:iam::250598593947:user/lgh91000-s",

   "STORAGE_AWS_EXTERNAL_ID":"MJB46484_SFCRole=4_ICqGupaL1237IJgY1fuXJgjKrqg=",
...
ALTER DATABASE ORDERS_DB SET CATALOG = 'SNOWFLAKE';

ALTER DATABASE ORDERS_DB SET EXTERNAL_VOLUME = 'iceberg_int';
...
CREATE OR REPLACE ICEBERG TABLE Customer_Accessory_iceberg (
    ...
    BASE_LOCATION = 'Customer_Accessory_iceberg';
