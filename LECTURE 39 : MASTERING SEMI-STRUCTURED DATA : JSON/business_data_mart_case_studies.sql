...
SELECT COUNT(*) FROM RAW.RAW_POS_DATA;
...
SELECT
  ...
  json_data:transaction:promo_codes:: ARRAY AS PROMO_CODES,
  json_data:transaction:review_comments:: STRING AS REVIEW_COMMENTS
FROM RAW.RAW_POS_DATA;
...
SELECT
  ...
  f.PROMO_CODES::STRING AS PROMO_CODES,
  ARRAY_SIZE(f.PROMO_CODES) AS NUM_PROMOS_USED
