...
╚══════════════════════════════════════════════════════════════════════════════╝
    ...
    try:
        ...
        from ADF_Analyzer_v10_Production.core.gemini_summary import generate_adf_lineage_summary
        ...
        # Now, call the Gemini summary function
        print("\nStarting Gemini summary generation...")
        # Make sure 'input_file' and 'output_folder' are the correct variable names from your script
        generate_adf_lineage_summary(json_file, args.output) 
